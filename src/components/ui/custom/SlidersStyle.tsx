    ...
    <div className="mt-5">
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 gap-5 mt-3'>
            {Design_Styles.map((style, index) => (
                <div key={index} className={`cursor-pointer ${style.styleName === selectedStyle ? 'p-2 border-2 border-gray-600 rounded-2xl': ''}`} onClick={() => setSelectedStyle(style.styleName)}>
