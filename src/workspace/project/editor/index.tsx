...
// This is a dummy slider code which is used to show while the actual slide is being generated by Gemini AI Live Model. It can be replaced with any static content or a loading spinner as needed.
...
function Editor() {
    ...
    const [projectDetail, setProjectDetail] = useState<Project>();    // to store the project detail
    ...
    useEffect(() => {     // This useEffect is used to start slide generation once projectDetail is fetched
    ...
    */
    ...
    const GenerateSlides = async () => {
        ...
        setIsSlidesGenerated(Date.now());     // mark that slides have been generated
    };
    ...
    useEffect(() => {          // save slides to firestore once all slides are generated every time
    ...
    const updateSliderCode = (updateSlideCode: string, index: number) => {   // this function is used to update the slide code when user edit the slide in slider editor
        setSliders((prev: any) => {
            const updated = [...prev];
            updated[index] = {
                ...updated[index],
